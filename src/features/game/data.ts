...
export const SURVIVAL_EVENTS: SurvivalEvent[] = [
  // Existing 10
  { day: 'Hari 1', title: 'Gaji masuk Rp3.000.000', desc: 'Awal bulan! Amankan dulu atau gas jajan?', aLabel: 'Auto-nabung 20%', bLabel: 'Gas jajan dulu', aEffect: -600000, bEffect: -400000, aNote: '600rb aman jadi tabungan. Sisanya 2,4jt.', bNote: 'Jajan 400rb. Tabungan? Nanti saja… (tidak ada)' },
  ...
  { day: 'Hari 16', title: 'Lembur dibayar', desc: 'Bos tawarkan lembur Sabtu, honor Rp300rb.', aLabel: 'Ambil lembur', bLabel: 'Rebahan saja', aEffect: 300000, bEffect: 0, aNote: '+300rb masuk! Mantap.', bNote: 'Istirahat penuh, saldo tetap.' },
  { day: 'Hari 19', title: 'HP retak', desc: 'Layar retak. Ganti tempered + servis Rp180rb, atau HP baru cicilan Rp500rb.', aLabel: 'Servis saja', bLabel: 'HP baru (cicilan)', aEffect: -180000, bEffect: -500000, aNote: 'HP mulus lagi. -180rb.', bNote: 'Gengsi naik, saldo -500rb.' },
  { day: 'Hari 22', title: 'Arisan kantor', desc: 'Diajak arisan Rp200rb/bulan, dapat lot awal.', aLabel: 'Ikut arisan', bLabel: 'Tolak halus', aEffect: -200000, bEffect: 0, aNote: 'Paksa nabung via arisan. -200rb.', bNote: 'Fokus ke tabungan sendiri.' },
  ...
  { day: 'Hari 20', title: 'Bocor Halus', desc: 'Ban motor bocor, tambal Rp15rb atau sekalian ganti ban baru Rp150rb karena udah tipis?', aLabel: 'Tambal Dulu', bLabel: 'Ganti Ban Baru', aEffect: -15000, bEffect: -150000, aNote: 'Aman sementara. -15rb.', bNote: 'Investasi keselamatan berkendara. -150rb.' },
