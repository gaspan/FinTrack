...
const makeStyles = (theme: Theme) => StyleSheet.create({
  ...
  sectionTitle: { ...theme.typography.subtitle, marginBottom: theme.spacing.md, marginLeft: theme.spacing.sm, fontSize: 13, textTransform: 'uppercase', letterSpacing: 1.2, fontWeight: '700' },
  item: {
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
    backgroundColor: theme.colors.surfaceElevated, padding: theme.spacing.lg,
    borderRadius: theme.radius.xl, marginBottom: theme.spacing.md,
    ...theme.shadow.sm,
  },
  itemLeft: { flexDirection: 'row', alignItems: 'center' },
  itemRight: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  iconBg: { width: 44, height: 44, borderRadius: theme.radius.xl, justifyContent: 'center', alignItems: 'center', marginRight: theme.spacing.md },
